package com.pulsevisual.client.audio;
...
public class AudioAnalyzer extends Thread {
    private PulseVisualizerOverlay pulsePanel;
    private volatile boolean running = true;
    private float amplitude = 1f;
    private TargetDataLine targetDataLine;
    private float[] audioBuffer = new float[256];
    
    public AudioAnalyzer(PulseVisualizerOverlay pulsePanel) {
        this.pulsePanel = pulsePanel;
        setDaemon(true);
        setName("PulseVisual-AudioAnalyzer");
    }
